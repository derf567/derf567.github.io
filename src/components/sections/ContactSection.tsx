  ...
  return (
    <section id="contact" className="section-padding bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <a
          href="mailto:wilfredomarinay@gmail.com"
          className="inline-flex px-8 py-3 bg-gradient-to-r from-primary to-purple-600 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300 text-lg mb-12 shadow-md"
        >
          Say Hello
        </a>
        ...
        <div className="flex justify-center gap-6 mt-16">
          <a
            ...
            className="w-12 h-12 bg-white border border-border rounded-full flex items-center justify-center text-muted-foreground hover:text-blue-600 hover:border-blue-600 transition-all duration-300 shadow-sm hover:shadow-md"
            aria-label="Facebook"
          >
          ...
          <a
            href="#"
            className="w-12 h-12 bg-white border border-border rounded-full flex items-center justify-center text-muted-foreground hover:text-pink-600 hover:border-pink-600 transition-all duration-300 shadow-sm hover:shadow-md opacity-50 cursor-not-allowed"
